...
function detectTypeByFilename(name: string) {
  ...
  if (n.includes("balance") || n.includes("bal stmt")) return "Balance Statement";
...
export default function MfLoanUploadPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-4xl mx-auto">
      <header>
        <h1 className="text-2xl font-bold text-[#0f172a]">Upload Portal — Supra Pacific MF Loan</h1>
      ...
      <section className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-sm text-blue-900 space-y-2">
        <p className="font-semibold">Expected File Types &amp; Required Columns:</p>
        <div className="space-y-1">
          <p><span className="font-medium">Balance Statement</span> — Customer Number · Principal Closing Balance · Rate of Interest · Disbursed Amount · Issue Date · DPD · Closing Principal Received · Closed On</p>
          <p><span className="font-medium">Transaction Statement</span> — Loan Account Number · Transaction Date · Principal Dr · Total Received</p>
        </div>
        <p className="text-xs text-blue-600">File name must include &quot;balance&quot; or &quot;transaction&quot; for auto-detection.</p>
      </section>
